...
cd $dir/src/hip/HIP-Examples/babelstream
make clean
make -f HIP.make
...
mkdir build
cd build
cmake ..  2>&1 | tee -a $cwd/hip-eigen-build.log
make -j8  2>&1 | tee -a $cwd/hip-eigen-build.log

cd $dir/hipeigen/build
make -j8 check -e 2>&1 | tee -a $cwd/hip-eigen-run.log


cd $dir/HIP/
mkdir build
cd build
cmake .. -DCMAKE_INSTALL_PREFIX=../install  2>&1 | tee -a $cwd/hip_directedtests_build.log
make -j8  2>&1 | tee -a $cwd/hip_directedtests_build.log
make install  2>&1 | tee -a $cwd/hip_directedtests_build.log
make check -j8 -e 2>&1 | tee -a $cwd/hip_directedtests.log
...
make
cd ../bin
./CoMD-amp --nx 60 --ny 60 --nz 60 -e 2>&1 | tee -a $cwd/compute-apps.log
echo "======================hpgmg-amp=============================="
cd ../../hpgmg-amp
make -f Makefile.hcc
cd build/bin
./hpgmg-fv-LC-clamp 6 8 -e 2>&1 | tee -a $cwd/compute-apps.log

echo "======================lulesh-amp=============================="
cd ../../../lulesh-amp
make
./lulesh -s 80 -i 100 -e 2>&1 | tee -a $cwd/compute-apps.log
...
make
./snap snap_input -e 2>&1 | tee -a $cwd/compute-apps.log

echo "======================xsbench-amp=============================="

cd ../../xsbench-amp/src
make
./XSBench -s small -e 2>&1 | tee -a $cwd/compute-apps.log
...
make -j 8 2>&1 | tee -a $cwd/gromacs_build.log
