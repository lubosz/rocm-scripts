...
run_flower_alexnet()
{
    ...
    python3 download_and_convert_data.py --dataset_name=flowers --dataset_dir=/dockerx/flower-alexnet
     ...
     python3 train_image_classifier.py --train_dir=/tmp/flowers-models/alexnet --dataset_name=flowers --dataset_split_name=train --dataset_dir=/dockerx/flower-alexnet --model_name=alexnet_v2 --max_number_of_steps=500 --batch_size=128 --num_clones=4 2>&1 | tee  flower-alexnet.txt
