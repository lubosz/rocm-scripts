...
./examples/mnist/train_lenet.sh --gpu 0,1 2>&1 | tee $logs/hipcaffe_mnist.log
./build/tools/caffe train --solver=examples/cifar10/cifar10_quick_solver.prototxt --gpu 0,1 2>&1 | tee $logs/hipcaffe_cifar10.log
