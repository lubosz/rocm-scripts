...
echo AH64_uh1 | sudo -S ./install.sh -cd | tee -a ~/dockerx/6rocfft_build.log 2>&1
export LD_LIBRARY_PATH=/opt/rocm/rocfft/lib:$LD_LIBRARY_PATH

cd build/release/clients/staging
#./rocfft-rider  | tee -a ~/dockerx/6rocfft_rocfft-rider.log 2>&1
./rocfft-test  | tee -a ~/dockerx/6rocfft_unittest.log 2>&1
