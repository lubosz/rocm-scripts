...
echo AH64_uh1 | sudo -S ./install.sh -cd >> ~/Desktop/logs/4rocblas_build.log 2>&1

cd build/release/clients/staging
./rocblas-test >> ~/Desktop/logs/4rocblas_unittest.log 2>&1
#./rocblas-bench >> ~/Desktop/logs/4rocblas_rocblas-bench.log 2>&1
