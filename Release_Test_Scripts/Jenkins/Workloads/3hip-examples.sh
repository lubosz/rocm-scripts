...
./HIP-nbody-block.sh >> ~/Desktop/logs/3hip-examples-mini-nbody.log 2>&1
echo "-----------HIP-nbody-orig----------" >> ~/Desktop/logs/3hip-examples-mini-nbody.log 2>&1
./HIP-nbody-orig.sh >> ~/Desktop/logs/3hip-examples-mini-nbody.log 2>&1
echo "-----------HIP-nbody-soa-----------" >> ~/Desktop/logs/3hip-examples-mini-nbody.log 2>&1
./HIP-nbody-soa.sh >> ~/Desktop/logs/3hip-examples-mini-nbody.log 2>&1
